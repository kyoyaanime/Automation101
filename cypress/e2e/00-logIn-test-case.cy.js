...
describe('All Login Tests', function() {
    ...
    it('TC-Login-001 | Login Page Verification', function() {
        ...
        cy.get('#WebPatterns_wt16_block_wtPassword > .Login_Text').should('have.text','PASSWORD')
        ...
        cy.get('#WebPatterns_wt16_block_wtAction_wtForgotUsername > .Underline').should('have.text','Forgot Username?')
    ...
    it('TC-Login-003 | Login Page Invalid Password', function() {
        ...
        loginPage.clickLogin()
        cy.get('.Feedback_Message_Error').should('be.visible')
        cy.get('.Feedback_Message_Text').should('have.text','Invalid Password.')
    })
    ...
    it('TC-Login-004 | Login Page Invalid Username', function() {
        ...
        loginPage.clickLogin()
        cy.get('.Feedback_Message_Error').should('be.visible')
        cy.get('.Feedback_Message_Text').should('have.text','User does not exist.')
    })
